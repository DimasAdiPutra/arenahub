...
import { LayoutDashboard, Store, LogOut, Home, X } from 'lucide-react';
...
export default function OwnerSidebar({ isOpen, onClose }) {
  ...
  // 🟢 Tambahkan dan sesuaikan menu navigasi owner di sini
  const navLinks = [
    { name: 'Dashboard', path: '/owner/dashboard', icon: <LayoutDashboard size={20} /> },
    { name: 'Kelola Arena', path: '/owner/spaces', icon: <Store size={20} /> },
  ];
